    ...
    <ul class="flex mr-[10%] font-Vazirs justify-center items-center">
      ...
      >
        <div class="flex items-center">
          <a
            @mouseover="showList()"
            class="cursor-pointer text-base text-gray-500"
            >سوپراپ اسنپ</a
          >
        ...
        >
          <li
            class="mt-2 cursor-pointer text-base text-gray-500 hover:text-green-500 hover:font-bold transition-text duration-200 w-fit"
          >
            درخواست تاکسی
          </li>
          <li
            class="mt-5 cursor-pointer text-base text-gray-500 hover:text-green-500 hover:font-bold transition-text duration-200 w-fit"
          >
            پیک موتوری
          </li>
          <li
      ...
      <a class="cursor-pointer text-base text-gray-500 mr-10"
        >ثبت نام راننده اسنپ</a
      >
      <a class="cursor-pointer text-base text-gray-500 mr-7">باشگاه رانندگان</a>
      <a class="cursor-pointer text-base text-gray-500 mr-7">پنل سازمانی</a>
      <a class="cursor-pointer text-base text-gray-500 mr-7">بلاگ</a>
      <div
      ...
      >
        <div class="flex items-center">
          <a
            @mouseover="showList2()"
            class="cursor-pointer text-base text-gray-500 mr-3"
            >درباره اسنپ
          </a>
          <span><arrowDown class="mr-3" /></span>
        </div>
  ...
  methods: {
    showList() {
      if (this.$refs.listVisible) {
        ...
        this.$refs.listVisible.style.display = "inline";
      }
    },
    hideShowList() {
      if (this.$refs.listVisible) {
        this.$refs.listVisible.style.opacity = "0";
        this.$refs.listVisible.style.display = "none";
      }
    },
    showList2() {
      if (this.$refs.listVisible2) {
        this.$refs.listVisible2.style.opacity = "1";
        this.$refs.listVisible2.style.display = "inline";
      }
    },
    hideShowList2() {
      if (this.$refs.listVisible2) {
        this.$refs.listVisible2.style.opacity = "0";
        this.$refs.listVisible2.style.display = "none";
      }
    },
  },
};
